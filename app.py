...
POOL_FILE = "/sdcard/Download/Operit/suyou_pools.json" if os.path.exists("/sdcard") else "suyou_pools.json"
...
if __name__ == '__main__':
    path = "/sdcard/Download/Operit/suyou_raw_nodes.txt" if os.path.exists("/sdcard") else "suyou_raw_nodes.txt"
